  ...
  CKEDITOR.dialog.add("link", function (g) {
    var n = CKEDITOR.plugins.link,
      ...
      var a = this.getDialog(),
          ...
          m = this.getValue();if (b && a) switch (b = b.getElement(), b.hide(), a.setValue(""), m) {case "frame":
          a.setLabel(g.lang.link.targetFrameName);a.getElement().show();break;case "popup":
          b.show();a.setLabel(g.lang.link.targetPopupName);a.getElement().show();break;default:
      ...
      a.advanced || (a.advanced = {});a.advanced[this.id] = this.getValue() || "";
        ...
        c = g.lang.common,
        b = g.lang.link,
        d;return { title: b.title, minWidth: 350, minHeight: 230, contents: [{ id: "info", label: b.info, title: b.info, elements: [{ id: "linkType", type: "select", label: b.type, "default": "url", items: [[b.toUrl, "url"], [b.toAnchor, "anchor"], [b.toEmail, "email"]], onChange: function onChange() {
            var a = this.getDialog(),
                b = ["urlOptions", "anchorOptions", "emailOptions"],
                m = this.getValue(),
                e = a.definition.getContents("upload"),
                e = e && e.hidden;"url" == m ? (g.config.linkShowTargetTab && a.showPage("target"), e || a.showPage("upload")) : (a.hidePage("target"), e || a.hidePage("upload"));for (e = 0; e < b.length; e++) {
              var c = a.getContentElement("info", b[e]);c && (c = c.getElement().getParent().getParent(), b[e] == m + "Options" ? c.show() : c.hide());
            }a.layout();
          }, setup: function setup(a) {
            this.setValue(a.type || "url");
          }, commit: function commit(a) {
            a.type = this.getValue();
          } }, { type: "vbox", id: "urlOptions", children: [{ type: "hbox", widths: ["25%", "75%"], children: [{ id: "protocol", type: "select", label: c.protocol, "default": "http://", items: [["http://‎", "http://"], ["https://‎", "https://"], ["ftp://‎", "ftp://"], ["news://‎", "news://"], [b.other, ""]], setup: function setup(a) {
                a.url && this.setValue(a.url.protocol || "");
              }, commit: function commit(a) {
                a.url || (a.url = {});a.url.protocol = this.getValue();
              } }, { type: "text", id: "url", label: c.url, required: !0, onLoad: function onLoad() {
                this.allowOnChange = !0;
              }, onKeyUp: function onKeyUp() {
                this.allowOnChange = !1;var a = this.getDialog().getContentElement("info", "protocol"),
                    b = this.getValue(),
                    m = /^((javascript:)|[#\/\.\?])/i,
                    c = /^(http|https|ftp|news):\/\/(?=.)/i.exec(b);c ? (this.setValue(b.substr(c[0].length)), a.setValue(c[0].toLowerCase())) : m.test(b) && a.setValue("");this.allowOnChange = !0;
              }, onChange: function onChange() {
                if (this.allowOnChange) this.onKeyUp();
              }, validate: function validate() {
                var a = this.getDialog();return a.getContentElement("info", "linkType") && "url" != a.getValueOf("info", "linkType") ? !0 : !g.config.linkJavaScriptLinksAllowed && /javascript\:/.test(this.getValue()) ? (alert(c.invalidValue), !1) : this.getDialog().fakeObj ? !0 : CKEDITOR.dialog.validate.notEmpty(b.noUrl).apply(this);
              }, setup: function setup(a) {
            ...
            id: "browse", hidden: "true", filebrowser: "info:url", label: c.browseServer }] }, { type: "vbox", id: "anchorOptions", width: 260, align: "center", padding: 0, children: [{ type: "fieldset", id: "selectAnchorText", label: b.selectAnchor, setup: function setup() {
              d = n.getEditorAnchors(g);this.getElement()[d && d.length ? "show" : "hide"]();
            ...
            id: "emailAddress", label: b.emailAddress, required: !0, validate: function validate() {
            ...
            label: b.emailSubject, setup: function setup(a) {
        ...
        label: b.upload, title: b.upload, hidden: !0, filebrowser: "uploadButton", elements: [{ type: "file", id: "upload", label: c.upload, style: "height:40px", size: 29 }, { type: "fileButton", id: "uploadButton", label: c.uploadSubmit, filebrowser: "info:url", "for": ["upload", "upload"] }] }, { id: "advanced", label: b.advanced, title: b.advanced, elements: [{ type: "vbox", padding: 1, children: [{ type: "hbox", widths: ["45%", "35%", "20%"], children: [{ type: "text", id: "advId", requiredContent: "a[id]", label: b.id, setup: h, commit: l }, { type: "select", id: "advLangDir",
              ...
              setup: h, commit: l }] }] }] }], onShow: function onShow() {
        var a = this.getParentEditor(),
            b = a.getSelection(),
            c = null;(c = n.getSelectedLink(a)) && c.hasAttribute("href") ? b.getSelectedElement() || b.selectElement(c) : c = null;a = n.parseLinkAttributes(a, c);this._.selectedElement = c;this.setupContent(a);
      }, onOk: function onOk() {
        var a = {};this.commitContent(a);var b = g.getSelection(),
            c = n.getLinkAttributes(g, a);if (this._.selectedElement) {
          var e = this._.selectedElement,
              d = e.data("cke-saved-href"),
              f = e.getHtml();e.setAttributes(c.set);e.removeAttributes(c.removed);
        ...
        g.config.linkShowAdvancedTab || this.hidePage("advanced");g.config.linkShowTargetTab || this.hidePage("target");
