...
(function () {
  ...
  */
   ...
   */
    ...
    */
			replaceWith: function replaceWith(data, mode) {
				if (data.trim() === '') {
	...
	function bindNotifications(editor, loader) {
		...
		function createAggregator() {
			...
			if (!aggregator || aggregator.isFinished()) {
				aggregator = editor._.uploadWidgetNotificaionAggregator = new CKEDITOR.plugins.notificationAggregator(editor, editor.lang.uploadwidget.uploadMany, editor.lang.uploadwidget.uploadOne);
