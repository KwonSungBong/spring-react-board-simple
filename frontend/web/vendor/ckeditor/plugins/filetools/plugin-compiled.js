...
(function () {
  ...
  */
   ...
   */
		create: function create(fileOrData, fileName) {
  ...
  */
   ...
   */
		loadAndUpload: function loadAndUpload(url) {
			var loader = this;
   ...
   */
		attachRequestListeners: function attachRequestListeners() {
			var loader = this,
			    xhr = this.xhr;
   ...
   */
		getUploadUrl: function getUploadUrl(config, type) {
   ...
   */
		isTypeSupported: function isTypeSupported(file, supportedTypes) {
