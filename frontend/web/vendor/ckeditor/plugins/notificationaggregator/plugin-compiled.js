...
(function () {
  ...
  */
   ...
   */
		createTask: function createTask(options) {
			options = options || {};
   ...
   */
		getDoneTaskCount: function getDoneTaskCount() {
   ...
   */
		_createNotification: function _createNotification() {
   ...
   */
		_addTask: function _addTask(options) {
   ...
   */
		_removeTask: function _removeTask(task) {
   ...
   */
		_onTaskUpdate: function _onTaskUpdate(evt) {
   ...
   */
		_onTaskDone: function _onTaskDone() {
			this._doneTasks += 1;
			this.update();
		}
	};
