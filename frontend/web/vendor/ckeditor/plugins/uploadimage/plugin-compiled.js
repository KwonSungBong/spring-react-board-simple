	...
	CKEDITOR.plugins.add('uploadimage', {
		...
		init: function init(editor) {
			...
			fileTools.addUploadWidget(editor, 'uploadimage', {
				...
				fileToElement: function fileToElement() {
				...
				onUploading: function onUploading(upload) {
					// Show the image during the upload.
					this.parts.img.setAttribute('src', upload.data);
				},

				onUploaded: function onUploaded(upload) {
					// Set width and height to prevent blinking.
					this.replaceWith('<img src="' + upload.url + '" ' + 'width="' + this.parts.img.$.naturalWidth + '" ' + 'height="' + this.parts.img.$.naturalHeight + '">');
				}
			});
